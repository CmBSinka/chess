...
namespace Chess
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            chessSprites = new Bitmap("C:\\Users\\jania\\source\\repos\\ChessGame-master\\Chess\\chess.png");
        ...
        {
            if (prevButton != null)
                prevButton.BackColor = Color.Peru;
            ...
            if (map[pressedButton.Location.Y / 50, pressedButton.Location.X / 50] != 0 && map[pressedButton.Location.Y / 50, pressedButton.Location.X / 50]/10 == currPlayer)
            {
                ...
                {
                    CloseSteps();
                    pressedButton.BackColor = Color.Peru;
                    ActivateAllButtons();
                    isMoving = false;
                }
                else
        ...
        public void CloseSteps()
        {
            for(int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    butts[i, j].BackColor = Color.Peru;
                }
            }
        }
